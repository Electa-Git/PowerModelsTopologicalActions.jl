...
#nb # > **How to use this notebook:** 
#nb # > Step 0 prepares all the packages needed to run the optimization models.
#nb # > Steps 1–3 and 6 are complemented by a slide deck, which is available in the repository.
#nb # > Steps 4–5 are meant to be run cell by cell, in order. Every code cell depends on the ones above it.
#md # !!! tip "How to use this page"
#md #     Step 0 prepares all the packages needed to run the optimization models
#md #     Steps 1–3 and 6 are complemented by a slide deck, which is available in the repository
#md #     Steps 4–5 are meant to be run cell by cell, in order. Every code cell depends on the ones above it.
