...
#nb # > **How to use this notebook.** Sections 1–3 and 8–9 are read-and-discuss.
#nb # > Sections 4–7 are meant to be run cell by cell, in order. Every code cell
#nb # > depends on the ones above it.
#md # !!! tip "How to use this page"
#md #     Sections 1–3 and 8–9 are read-and-discuss. Sections 4–7 are meant to be run
#md #     in order — every snippet depends on the ones above it. The runnable notebook
#md #     and the plain script are generated from this same source.
