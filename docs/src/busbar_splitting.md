...
![Possible configurations of the exclusivity constraint for each network element connected to a busbar potentially being split.](docs/src/images/Figure_5_SEGAN.png)
